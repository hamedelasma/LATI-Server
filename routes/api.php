...
Route::middleware('auth:api')->group(function () {
    ...
    Route::put('users/tasks/{id}',[UserTaskController::class,'update']);
    ...
    Route::post('tasks/{code}', [TaskController::class, 'store']);
    Route::get('tasks/{code}', [TaskController::class, 'index']);
